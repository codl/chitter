...
class Account < ApplicationRecord
  ...
  # hack to prevent bidi shenanigans in display names
  # there is a fix for this in upstream but it only fixes it in the web application
  # this also fixes it in apps
